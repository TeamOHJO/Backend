...
public class AccommodationController {
    ...
    public ResponseEntity<ResponseDTO<List<AccommodationFindResponse>>> getAccommodationsInMainPage(
        ...
        ResponseDTO<List<AccommodationFindResponse>> response = accommodationService.getAccommodationsInMainPage(
            principalDetails, category, isDomestic, pageable, startDate, endDate, numberOfPeople);
